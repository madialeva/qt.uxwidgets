...
de datos, autocontenido e independiente de cualquier aplicación. Ofrece un control de
entrada compuesto y configurable (texto, número o fecha) organizado en dos capas —un
campo tipado que hereda de `QLineEdit` y un control compuesto etiqueta/campo/icono que
hereda de `QWidget`— para no tener que crear y alinear tres widgets por cada campo en
formularios densos.
